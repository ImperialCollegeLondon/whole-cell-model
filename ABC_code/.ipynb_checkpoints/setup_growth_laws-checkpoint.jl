...
init= [s_out,rmr_0,em_0,rmq_0,rmt_0,et_0,rmm_0,
    ...
    rep1,rep2,rep3,rep1_mrna,rep2_mrna,rep3_mrna,rep1_mrna_ribo,rep2_mrna_ribo,rep3_mrna_ribo]
...
"""The most basic ODE model of Amino Acid metabolism with no cell growth and no changes in external carbon or nitrogen sources.
Nitrogenase equations are still present but not active (inital conditions = 0, dx/dt = 0). Updated gamma equation (rate of translational elongation) that uses both ATP and amino acids as substrates. Includes 9 extra equations representing the 3 repressor proteins, their 3 mRNAs, and 3 mRNA-ribo complexes. Equations 26 to 33.
    """
function AA_simple_repressilator(results,y,p,t)
    s_out = y[1] #external level of substrate, a proxy for plant growth state since more plant = more substrate
    rmr= y[2]#num of ribosome/ribosomal mRNA complex molecules
    em= y[3]#metabolic enzyme molecumes
    rmq= y[4]#num of ribosome/housekeeping mRNA complex molecules
    ...
    rep1=y[26]#num of repressor protein 1
    rep2=y[27]#num of repressor protein 2
    rep3=y[28]#num of repressor protein 1  
    rep1_mrna=y[29]#num of free mRNA that makes repressor protein 1
    rep2_mrna=y[30]#num of free mRNA that makes repressor protein 2
    rep3_mrna=y[31]#num of free mRNA that makes repressor protein 3
    rep1_mrna_ribo=y[32]#num of mRNA bound to ribos that makes repressor protein 1
    rep2_mrna_ribo=y[33]#num of mRNA bound to ribos that makes repressor protein 2
    rep3_mrna_ribo=y[34]#num of mRNA bound to ribos that makes repressor protein 3
...
#     new_AA = AA_vo
    ...
    #repressilator equations#
    ########################################    
    results[26]= (gam/nx)*rep1_mrna_ribo -lam*rep1 #num of repressor protein 1
    results[27]= (gam/nx)*rep2_mrna_ribo -lam*rep2 #num of repressor protein 2
    results[28]= (gam/nx)*rep3_mrna_ribo -lam*rep3 #num of repressor protein 3
    
    results[29]= (w_rep*a/thetax+a) +ku*rep1_mrna_ribo +(gam/nx)*rep1_mrna_ribo -kb*r*rep1_mrna -dm*rep1_mrna -lam*rep1_mrna
    #num of free mRNA that makes repressor protein 1  
    results[30]= (w_rep*a/thetax+a) +ku*rep2_mrna_ribo +(gam/nx)*rep2_mrna_ribo -kb*r*rep2_mrna -dm*rep2_mrna -lam*rep2_mrna
    #num of free mRNA that makes repressor protein 2
    results[31]= (w_rep*a/thetax+a) +ku*rep3_mrna_ribo +(gam/nx)*rep3_mrna_ribo -kb*r*rep3_mrna -dm*rep3_mrna -lam*rep3_mrna
    #num of free mRNA that makes repressor protein 3
    
    results[32]= (w_rep*a/(thetax+a)) +ku*rep1_mrna_ribo +gam/nx*rep1_mrna_ribo -kb*r*rep1_mrna -dm*rep1_mrna -lam*rep1_mrna
    #num of mRNA bound to ribos that makes repressor protein 1
    results[33]= (w_rep*a/(thetax+a)) +ku*rep2_mrna_ribo +gam/nx*rep2_mrna_ribo -kb*r*rep2_mrna -dm*rep2_mrna -lam*rep2_mrna
    #num of mRNA bound to ribos that makes repressor protein 2
    results[34]= (w_rep*a/(thetax+a)) +ku*rep3_mrna_ribo +gam/nx*rep3_mrna_ribo -kb*r*rep3_mrna -dm*rep3_mrna -lam*rep3_mrna
    #num of mRNA bound to ribos that makes repressor protein 3
