...
println("Packages compiled, defining parameters.")
...
#         legend=:best,
    #     palette=:heat
    #     seriescolor=:auto
        color = ["#ffe119" "#3cb44b" "#0082c8" "#808080" "#46f0f0" "#f032e6" "#d2f53c" "#fabebe" "#008080" "#e6beff" "#aa6e28" "#800000" "#808000" "#ffd8b1" "#000080" "#f58231" "#911eb4" "#e6194b" :grey "#000000" "#aaffc3" :brown :green :blue :purple]
    )
