...
println("Please input how many timesteps you would like this initial burn in phase to be (1000+ recommended)")
...
println("Please input how many timesteps you would like the second burn in phase to be (1000+ recommended)")
...
println("running cell growth burn in")
...
println("Please input how many timesteps you would like the amino acid model to run (1000+ recommended)")
