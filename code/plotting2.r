...
plot(y= AA_3$value22, x=AA_3$timestamp, ylab = "num of AA (k_ribo_AA_a:10000.0)")

params_data = read.csv("../data/high-AA-params-file-0.01-0.01-0.01-0.01-0.01-0.01-0.01-0.01-0.01-10000.0.csv")
