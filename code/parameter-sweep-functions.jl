...
function AA_simple(results,y,p,t)
    ...
    if s_out <0.000001 s_out=0.000001 end
    if rmr<0.000001 rmr= 0.000001 end
    if em<0.000001 em=0.000001 end
    if rmq<0.000001 rmq=0.000001 end
    if rmt<0.000001 rmt=0.000001 end
    if et<0.000001 et=0.000001 end
    if rmm<0.000001 rmm=0.000001 end
    if mt<0.000001 mt=0.000001 end
    if mm<0.000001 mm=0.000001 end
    if q<0.000001 q=0.000001 end
    if si<0.000001 si=0.000001 end
    if mq<0.000001 mp=0.000001 end
    if mr<0.000001 mr=0.000001 end
    if r < 0.000001 r = 0.000001 end    
    if NH4<0.000001 NH4=0.000001 end
    if nit_mrna<0.000001 nit_mrna=0.000001 end
    if nit_mrna_ribo<0.000001 nit_mrna_ribo=0.000001 end
    if nit<0.000001 nit=0.000001 end
    if N<0.000001 N=0.000001 end
    if a<0.000001 a=0.000001 end
    if AA<0.000001 AA=0.000001 end
    if AA_prot<0.000001 AA_prot=0.000001 end
    if AA_mrna<0.0000001 AA_mrna=0.0000001 end    
    if AA_mrna_ribo<0.000001 AA_mrna_ribo=0.000001 end
