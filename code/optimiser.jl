...
JuMP.register(modelAA, :gamma_finder, 33, gamma_finder, autodiff = true)

@NLobjective(modelAA, Max, gamma_finder(k_ribo_a_var,k_ribo_a_AA_var,k_ribo_AA_a_var,
    k_a_var,k_cat_AA_var,k_NH4_var,k_a_AA_var,k_NH4_AA_var,
    s_out,rmr_0,em_0,rmq_0,rmt_0,et_0,rmm_0,mt_0,mm_0,q_0,si_0,mq_0,mr_0,r_0,
    NH4_0,nit_mrna_0,nit_mrna_ribo_0,nit_0,exported_0,N_0,a_0, AA_0, AA_prot_0,AA_mrna_0,AA_mrna_ribo_0))
